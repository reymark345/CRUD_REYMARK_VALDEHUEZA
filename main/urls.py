...
urlpatterns = [
    ...
    path('predict_detail', views.predict_detail, name='predict-detail'),
    path('household_details', views.household_details, name='household-details'),
    path('validated_details', views.validated_details, name='validated-details'),
]
